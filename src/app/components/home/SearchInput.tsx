  ...
  return (
    <div className="max-w-xl mx-auto">
        <div className="flex items-center border border-border rounded-x overflow-hidden p-1">
            <input type="text" placeholder="Search articles..." value={query} onChange={(e) => setQuery(e.target.value) } className="w-full px-4 py-3 bg-transparent outline-none text-sm text-text placeholder-gray-500"/>
