  ...
  return (
    <ContainerLayout>
      <main className="max-w-2xl mx-auto">
        ...
        <h1 className="mt-3 texxt-3xl md:text-4xl font-bold text-text leading-tight">
        ...
        <article className="mt-10 text-gray-400 space-y-6">
          <p>
            Building a fullstack blog with Next.js is one of the best ways to
            learn modern web development. It gives you the ability to handle
            both frontend and backend logic within a single framework.
          </p>
          <p>
            Next.js provides powerful features such as file-based routing,
            sever-side renedering, and API routes. These tools make it easier to
            create fast, scalable, and production-ready application.
          </p>
        </article>
      </main>
    </ContainerLayout>
