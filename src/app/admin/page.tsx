    ...
    <main className="md:ml-64 p-4 sm:p-6 min-h-screen">
        ...
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mb-8 sm:mb-10">
            <div className="bg-card border border-border rounded-xl p-4">
                ...
                <h2 className="text-xl sm:text-02xl font-semibold text-text mt-2">12</h2>
            </div>
             <div className="bg-card border border-border rounded-xl p-4">
                <p className="text-sm text-gray-400">Authors</p>
                <h2 className="text-xl sm:text-02xl font-semibold text-text mt-2">3</h2>
            </div>
        </div>
        {/* Recent Posts */}
        <div className="bg-card border border-border rounded-xl p-4 sm:p-5">
         <div className="flex justify-between items-center mb-4">
               <h2 className="text-base sm:text-lg font-semibold text-text">Recent Posts</h2>
