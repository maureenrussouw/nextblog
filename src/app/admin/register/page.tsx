            ...
            <div className="w-full max-w-md bg-card border border-border rounded-xl p-6">
                ...
                <form onSubmit={handleRegister} className="mt-6 space-y-4">
                  <div>
                    ...
                    type="text" placeholder="Author name" className="w-full px-3 py-2 bg-surface border border-border rounded-lg outline-none text-sm text-text placeholder-gray-500 focus:border-primary" />
                  </div>
                   <div>
                    <label className="block text-sm text-gray-400 mb-1">
                      Email
